...
- The script automatically processes each PDF and produce a folder json_files. Inside the folder the script generates and saves a matching `.json` version for each paper.
